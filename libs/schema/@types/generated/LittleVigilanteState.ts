...
export class LittleVigilanteState extends Schema {
    ...
    @type({ map: "boolean" }) public currentDownState: MapSchema<boolean> = new MapSchema<boolean>();
    @type({ map: "number" }) public lastDownState: MapSchema<number> = new MapSchema<number>();
